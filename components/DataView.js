...
const DataView = () => {
  ...
  const [varia, setVaria] = React.useState({
    var_id: 0,
    title: 'Variabel Belum Dipilih',
  });
  ...
  return (
    <View
        ...
        <Modal
          ...
          {catLoaded ? (
              ...
              renderItem={({item}) => {
                return (
                  <Chip
                    ...
                    selected={s(item.subcat_id, category.subcat_id)}>
                    {item.title}
                  </Chip>
                );
              }}
            ...
            <ScrollView
              ...
              refreshControl={
                <RefreshControl
                  refreshing={!subsLoaded}
                  onRefresh={() => {
                    getCat();
                  }}
                />
              }>
              {catNettErr && catLoaded ? (
                <Title>Gagal memuat kategori, silahkan refresh kembali</Title>
              ) : (
        ...
        <Modal
          ...
          {subjects.length > 0 && subsLoaded ? (
              ...
              renderItem={({item}) => {
                return (
                  <Chip
                    ...
                    selected={s(item.sub_id, subject.sub_id)}>
                    {item.title}
                  </Chip>
                );
              }}
            ...
            <Title
              ...
              Tidak Ada Subjek dari kategori {category.title}
            </Title>
          ) : (
            <ScrollView
              style={{
              ...
              {subsNetError ? (
                <Title>Gagal memuat subjek, silahkan refresh kembali</Title>
              ) : (
                <ActivityIndicator animating={true} />
              )}
            </ScrollView>
        ...
        <Modal
          ...
          {vars.length > 0 && varsLoaded ? (
              ...
              renderItem={({item}) => {
                return (
                  <Chip
                    ...
                    selected={s(item.var_id, varia.var_id)}>
                    {item.title}
                  </Chip>
                );
              }}
            ...
            <Title
              ...
              Tidak ada variabel dari subjek {subject.title}{' '}
            </Title>
          ) : (
            <ScrollView
              style={{
      ...
      <Snackbar
        ...
        Gagal memuat kategori selanjutnya
      </Snackbar>
      <Snackbar
        visible={snackS}
        action={{
        ...
        Gagal memuat subjek selanjutnya
      </Snackbar>
      <Snackbar
        visible={snackV}
        action={{
        ...
        Gagal memuat variabel selanjutnya
      </Snackbar>
    </View>
  );
};
